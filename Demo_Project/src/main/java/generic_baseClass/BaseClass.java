...
public class BaseClass {
	...
	public void loginToApp() throws IOException {
		...
		String url = System.getProperty("url",prop.getDataFromProperties("url"));
		String username = System.getProperty("username",prop.getDataFromProperties("username"));
		String password = System.getProperty("password",prop.getDataFromProperties("password"));
